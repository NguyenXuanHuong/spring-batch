...
public class SalesInfoIntegrationConfig {
    ...
    private final Job importStudentScoreJobDeprecated;
    private final JobRepository jobRepository;


    private String salesDirectory = "H:/udemy/spring batch/spring batch-youtube/youtube-2/spring-batch/spring-batch/src/main/resources/csv";

    public SalesInfoIntegrationConfig(Job importStudentScoreJobDeprecated, JobRepository jobRepository) {
        this.importStudentScoreJobDeprecated = importStudentScoreJobDeprecated;
    ...
    public FileMessageToJobRequest fileMessageToJobRequest(){
        ...
        transformer.setJob(importStudentScoreJobDeprecated);
